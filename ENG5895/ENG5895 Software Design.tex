...
• Three ways of using:
1. Sketch (what we use)
2. Blueprint
3. Programming language
\subsubsection{Class Relationships in UML}
...
Software Design – MT2 Study Guide // Winter 2018 5
...
Software Design – MT2 Study Guide // Winter 2018 6
...
\section{Technologies: Threads and Concurrency in Java -- Part 1 and 2)
